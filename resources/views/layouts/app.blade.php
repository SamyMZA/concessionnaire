                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="lang/en"><img src="{{asset('/images/en.png')}}" width="30px" height="20px">    Anglais</a>  
                                <a class="dropdown-item" href="lang/fr"><img src="{{asset('/images/fr.png')}}" width="30px" height="20px">    Francais</a>   
                            </div>
                        </li>
